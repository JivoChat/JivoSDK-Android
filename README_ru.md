...
-   добавлена опция отключения логирования
-   добавлена проверка тега при логировании
-   добавлена возможность кастомизации подсказки поля ввода
-   добавлена поддержка Markdown для приветственного сообщения
-   пункт меню «Технический журнал» доступен по долгому нажатию
-   добавлен стиль для всплывающего меню
-   добавлен стиль для фона области сообщений чата
