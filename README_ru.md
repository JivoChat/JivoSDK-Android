...
-   исправлено перекрытие клавиатурой поле ввода;
-   исправлены ошибки, которые вызывали некорректную работу SDK
-   добавлена возможность замены замены заголовка push - уведомлений;
